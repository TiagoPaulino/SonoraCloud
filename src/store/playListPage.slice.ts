...
const data = {
  ...
  user_id: "443778",
  user_name: "dale88",
  zip: "https://storage.jamendo.com/download/p100044/mp32/",
  tracks: [
    {
      id: "97149",
      name: "Kismet",
...
export const playListPageSlice = createSlice({
  name: "playListPage",
  initialState: {} as playlistData,
  reducers: {
    playlistUpdate: (state, action: PayloadAction<playlistData>) => {
      state = action.payload;
    },
  },
});

export const { playlistUpdate } = playListPageSlice.actions;
export default playListPageSlice.reducer
